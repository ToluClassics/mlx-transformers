...
class TestMlxBert(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.model_name = "google-bert/bert-base-uncased"
        cls.model_class = MlxBertModel
...
class TestMlxBertForSequenceClassification(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.model_class = MlxBertForSequenceClassification
...
class TestMlxBertForTokenClassification(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls) -> None:
        cls.model_name = "dbmdz/bert-large-cased-finetuned-conll03-english"
        cls.model_class = MlxBertForTokenClassification
...
class TestMlxBertForQuestionAnswering(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.model_class = MlxBertForQuestionAnswering
