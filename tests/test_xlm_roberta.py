...
class TestMlxXLMRobertaForSequenceClassification(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.config = XLMRobertaConfig.from_pretrained(cls.model_name)
        cls.model = MlxXLMRobertaForSequenceClassification(cls.config)
...
class TestMlxXLMRobertaForTokenClassification(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.config = XLMRobertaConfig.from_pretrained(cls.model_name)
        cls.model = MlxXLMRobertaForTokenClassification(cls.config)
...
class TestMlxXLMRobertaForQuestionAnswering(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.config = XLMRobertaConfig.from_pretrained(cls.model_name)
        cls.model = MlxXLMRobertaForQuestionAnswering(cls.config)
        cls.model.from_pretrained(cls.model_name, revision="main")
